        ...
        >
          ...
          <div className="card-body">
            <form>
              ...
              <button
                type="submit"
                className="btn bg-color custom-bg-text w-50 p-2.5 rounded-pill"
                onClick={loginAction}
              >
                Login
              </button>
              <Link to="/user/register" className="nav-link active m-1" aria-current="page"> New User?
          <b className="text-color">Register Here</b>
           </Link>
              <ToastContainer />
            </form>
          </div>
